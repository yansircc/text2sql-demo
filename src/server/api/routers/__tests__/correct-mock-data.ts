...
export const correctQueryAnalysisMock = {
	...
	hybrid: {
		...
		hybridConfig: {
			description:
				"First perform vector search to find similar companies, then join with orders table for recent data",
		},
	},
	...
	rejected: {
		...
		feasibility: {
			...
			suggestedAlternatives: [
				"Try searching for specific company or order information",
			],
		},
		clarity: {
			isClear: true,
	...
	unclear: {
		...
		clarity: {
			...
			missingInfo: [
				...
				{
					field: "filters",
					description: "Any specific filters or time range?",
				},
			],
		},
		routing: {
